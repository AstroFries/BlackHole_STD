...
template <> inline double gamma_sph<1>(double r, double theta, double phi, double t) { return -0.5*pow(a, 2)*sin(2*theta)/(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2)); }
...
template <> inline double gamma_sph<4>(double r, double theta, double phi, double t) { return -0.5*pow(a, 2)*sin(2*theta)/(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2)); }
...
template <> inline double gamma_sph<16>(double r, double theta, double phi, double t) { return 0.5*pow(a, 2)*sin(2*theta)/((pow(a, 2)*pow(cos(theta), 2) + pow(r, 2))*(pow(a, 2) + pow(r, 2) - 2*r)); }
...
template <> inline double gamma_sph<21>(double r, double theta, double phi, double t) { return -0.5*pow(a, 2)*sin(2*theta)/(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2)); }
...
template <> inline double gamma_sph<27>(double r, double theta, double phi, double t) { return 1.0*a*r*(pow(a, 2) + pow(r, 2))*sin(2*theta)/pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 3); }
...
template <> inline double gamma_sph<30>(double r, double theta, double phi, double t) { return 1.0*a*r*(pow(a, 2) + pow(r, 2))*sin(2*theta)/pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 3); }
template <> inline double gamma_sph<31>(double r, double theta, double phi, double t) { return -1.0*pow(a, 2)*r*sin(2*theta)/pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 3); }
...
template <> inline double gamma_sph<34>(double r, double theta, double phi, double t) { return pow(a, 2)*(-1.0*pow(a, 4)*pow(cos(theta), 4) - 2.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 0.125*pow(a, 2)*r*(cos(4*theta) - 1) + 2.0*pow(a, 2)*r*pow(cos(theta), 2) - 1.0*pow(r, 4) - 3.0*pow(r, 3)*pow(sin(theta), 2) + 2.0*pow(r, 3))/(r*pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(1.0*pow(a, 2) + 1.0*pow(r, 2) - 2.0*r)); }
template <> inline double gamma_sph<35>(double r, double theta, double phi, double t) { return -1.0*a*(pow(a, 2)*pow(cos(theta), 2) - pow(r, 2))/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(pow(a, 2) + pow(r, 2) - 2*r)); }
...
template <> inline double gamma_sph<38>(double r, double theta, double phi, double t) { return 2.0*pow(a, 2)*r*sin(2*theta)/(2.0*pow(a, 4)*pow(cos(theta), 4) + 4.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 2.0*pow(r, 4)); }
template <> inline double gamma_sph<39>(double r, double theta, double phi, double t) { return -2.0*a*r/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*tan(theta)); }
template <> inline double gamma_sph<40>(double r, double theta, double phi, double t) { return pow(a, 2)*(-1.0*pow(a, 4)*pow(cos(theta), 4) - 2.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 0.125*pow(a, 2)*r*(cos(4*theta) - 1) + 2.0*pow(a, 2)*r*pow(cos(theta), 2) - 1.0*pow(r, 4) - 3.0*pow(r, 3)*pow(sin(theta), 2) + 2.0*pow(r, 3))/(r*pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(1.0*pow(a, 2) + 1.0*pow(r, 2) - 2.0*r)); }
template <> inline double gamma_sph<41>(double r, double theta, double phi, double t) { return 2.0*pow(a, 2)*r*sin(2*theta)/(2.0*pow(a, 4)*pow(cos(theta), 4) + 4.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 2.0*pow(r, 4)); }
...
template <> inline double gamma_sph<44>(double r, double theta, double phi, double t) { return -1.0*a*(pow(a, 2)*pow(cos(theta), 2) - pow(r, 2))/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(pow(a, 2) + pow(r, 2) - 2*r)); }
template <> inline double gamma_sph<45>(double r, double theta, double phi, double t) { return -2.0*a*r/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*tan(theta)); }
...
template <> inline double gamma_sph<51>(double r, double theta, double phi, double t) { return 1.0*(pow(a, 4)*pow(sin(theta), 2) - pow(a, 4) + pow(a, 2)*pow(r, 2)*pow(sin(theta), 2) + pow(r, 4))/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(pow(a, 2) + pow(r, 2) - 2*r)); }
...
template <> inline double gamma_sph<54>(double r, double theta, double phi, double t) { return 2.0*pow(a, 3)*r*pow(sin(theta), 3)*cos(theta)/pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2); }
template <> inline double gamma_sph<55>(double r, double theta, double phi, double t) { return -4.0*pow(a, 2)*r*sin(2*theta)/(4.0*pow(a, 4)*pow(cos(theta), 4) + 8.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 4.0*pow(r, 4)); }
...
template <> inline double gamma_sph<57>(double r, double theta, double phi, double t) { return 2.0*pow(a, 3)*r*pow(sin(theta), 3)*cos(theta)/pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2); }
...
template <> inline double gamma_sph<60>(double r, double theta, double phi, double t) { return 1.0*(pow(a, 4)*pow(sin(theta), 2) - pow(a, 4) + pow(a, 2)*pow(r, 2)*pow(sin(theta), 2) + pow(r, 4))/(pow(pow(a, 2)*pow(cos(theta), 2) + pow(r, 2), 2)*(pow(a, 2) + pow(r, 2) - 2*r)); }
template <> inline double gamma_sph<61>(double r, double theta, double phi, double t) { return -4.0*pow(a, 2)*r*sin(2*theta)/(4.0*pow(a, 4)*pow(cos(theta), 4) + 8.0*pow(a, 2)*pow(r, 2)*pow(cos(theta), 2) + 4.0*pow(r, 4)); }
