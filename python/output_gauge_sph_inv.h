...
template <> inline double g_sph<0>(double r, double theta, double phi, double t) { return (pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2))/(pow(r, 2) - 2*r + 1.0/9.0); }
...
template <> inline double g_sph<5>(double r, double theta, double phi, double t) { return pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2); }
...
template <> inline double g_sph<10>(double r, double theta, double phi, double t) { return (pow(r, 2) + (2.0/9.0)*r*pow(sin(theta), 2)/(pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2)) + 1.0/9.0)*pow(sin(theta), 2); }
template <> inline double g_sph<11>(double r, double theta, double phi, double t) { return -2.0/3.0*r*pow(sin(theta), 2)/(pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2)); }
...
template <> inline double g_sph<14>(double r, double theta, double phi, double t) { return -2.0/3.0*r*pow(sin(theta), 2)/(pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2)); }
template <> inline double g_sph<15>(double r, double theta, double phi, double t) { return 2*r/(pow(r, 2) + (1.0/9.0)*pow(cos(theta), 2)) - 1; }
