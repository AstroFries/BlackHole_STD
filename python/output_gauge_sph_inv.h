...
template <> inline double g_sph<0>(double r, double theta, double phi, double t) { return 1.0/(1 - 2/r); }
...
template <> inline double g_sph<5>(double r, double theta, double phi, double t) { return pow(r, 2); }
...
template <> inline double g_sph<10>(double r, double theta, double phi, double t) { return pow(r, 2)*pow(sin(theta), 2); }
template <> inline double g_sph<11>(double r, double theta, double phi, double t) { return 0; }
...
template <> inline double g_sph<14>(double r, double theta, double phi, double t) { return 0; }
template <> inline double g_sph<15>(double r, double theta, double phi, double t) { return -1 + 2/r; }
